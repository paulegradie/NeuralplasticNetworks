...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Experiment 5: contextual successor world.")
    parser.add_argument("--db", type=Path, default=Path("runs/exp5_contextual_successor.sqlite3"))
    parser.add_argument("--run-name", type=str, default="exp5_full_contextual_traversal")
