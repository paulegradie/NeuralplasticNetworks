...
The helper scripts in this experiment use a shared parent virtualenv at `../.venv`, matching the existing `start.sh`.
...
Helper scripts are available for both shells:
