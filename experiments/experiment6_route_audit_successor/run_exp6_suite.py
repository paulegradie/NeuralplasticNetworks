...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Experiment 6 controlled variants.")
...
def main() -> None:
    ...
    variants = [
        ...
        ("exp6_no_recurrence", ["--no-recurrence"]),
        ("exp6_no_structural_plasticity", ["--no-structural-plasticity"]),
        ("exp6_no_reward_gate", ["--no-reward-gate"]),
        ("exp6_no_homeostasis", ["--no-homeostasis"]),
        ("exp6_no_context_routing", ["--no-context-routing"]),
        ("exp6_no_inhibition", ["--no-inhibition"]),
    ]
