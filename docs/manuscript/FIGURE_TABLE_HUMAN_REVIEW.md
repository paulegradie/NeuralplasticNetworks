...
Status: post-human-decision placement tracker and post-compact Table 3 split; still not a final journal art/caption approval.
...
Caveat: Candidate assets are not automatically final submission figures. Compact Table 3 is descriptive and final-safe for the current manuscript pass, but it does not claim final inferential effect sizes or approved comparison-family statistics.
...
2. Polish captions for Figures 1-3, Figure 5, compact Table 3, and Table 4.
3. Align manuscript prose so Table 3 refers to `docs/manuscript/tables/table_03_compact_final_safe.md` and the detailed generated statistical map remains candidate/supplementary.
4. Decide later, based on venue/reviewer strategy, whether Table 1/Table 2 remain main/supporting or move to supplement/repository appendix.
