...
| Exp13.1 hardening run | Exp13 no-context-binding, holdout metrics, stochastic corruption, and consolidation dose-response need correction. | `docs/threads/experiment12to13_export.md` | No Exp13.1 directory exists. | Create a new future Exp13.1 experiment directory under `experiments/`; do not modify Exp13 outputs in place. |
